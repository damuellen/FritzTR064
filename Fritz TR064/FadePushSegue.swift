...
class FadePushSegue: UIStoryboardSegue {
	...
	override func perform() {
		...
		(destination.bgView.layer.sublayers![0] as! CAGradientLayer).colors =
			((sourceViewController as! ActionArgumentsVC).bgView.layer.sublayers![0] as! CAGradientLayer).colors
